---
title: "Tool Making & Mechanical Engineering – Furnaces for Hardening and Manufacturing"
description: "Industrial furnaces for tool making and mechanical engineering: hardening of tool steels, stress relieving, normalising, heavy loads up to 30 t. NTH Therm chamber and bogie hearth furnaces."
translationKey: "industry-tool-mechanical"
layout: "industry"
weight: 30
intro: "In tool making and mechanical engineering, heat treatment decides service life, dimensional accuracy and freedom from failure. NTH Therm furnaces cover the full range — from laboratory furnace to bogie hearth for 30-tonne loads."
products:
...
faqs:
  - q: "Which tool steels are typically heat treated?"
    a: "High-speed steels (HSS: M2, M35, M42), cold-work steels (D2, K110, K340), hot-work steels (H13, H11, 1.2343), plastic mould steels (P20, 1.2311, 1.2312) and stainless steels for corrosion-resistant tooling. Each steel requires specific austenitising temperatures and cooling programmes."
  - q: "What is the advantage of the IWF bogie hearth for heavy loads?"
    a: "The IWF is specifically designed for charges of 5 to over 30 tonnes — for large dies, machine components, press and forging elements. The reinforced bogie construction and optimised gas flow ensure even temperature distribution even at high loading."
  - q: "What temperatures are needed for stress relieving of machine components?"
    a: "Stress relieving typically occurs at 500–650 °C depending on material (steel: 550–650 °C, cast iron: 500–600 °C, welded S355 structures: 580–620 °C). Slow heating and cooling rates are important (≤ 50 K/h for sensitive structures), along with adequate hold times to relieve residual stresses."
  - q: "Can the IRF multi-door furnace run different processes in succession?"
