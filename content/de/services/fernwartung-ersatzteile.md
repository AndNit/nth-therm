...
- Online-Diagnose laufender Programme und Zustandsabfragen aller I/Os
- Parameteranpassungen und Rezeptoptimierungen
- Sicherheitsüberbrückungen für kontrollierte Fehleranalyse (protokolliert)
- Softwareupdates und Programmkorrekturen einspielen
- Fernunterstützung für Ihr Wartungspersonal bei der mechanischen Entstörung

**Reaktionszeiten:**
| Priorität | Zielvorgabe |
|-----------|-------------|
| Produktionsstillstand | Erste Remote-Diagnose ≤ 4 Stunden |
| Betrieb mit Einschränkung | Erste Remote-Diagnose ≤ 8 Stunden |
| Planungsanfrage | Rückmeldung ≤ nächster Werktag |
...
- Drucktransmitter und Druckschalter (Atmosphärenöfen)

**Fremdanlagen-Ersatzteile:**
