---
title: "Drymatic Wärmetrocknungssysteme – Professionelle Schadensanierung"
description: "Drymatic Wärmetrocknungssysteme von NTH Therm: Drymatic II, Boost Bar, Trocknungsmatten. Schnellere Trocknung bei Wasserschäden durch gezielte Wärme. Autorisierter Distributor für Deutschland."
...
### Drymatic II – Das intelligente Herzstück

Der **Drymatic II** ist die Zentrale des Systems. Er versorgt alle angeschlossenen Adapter und Trocknungsmatten mit präzise geregelter Wärme und steuert automatisch Energieeinsatz, Luftstrom und Temperatur.

| Parameter | Wert |
|-----------|------|
| Gewicht | 28 kg |
| Max. Luftstrom | 595 m³/h |
| Anschluss | 230 V, Schuko (13 A) |
| Adapter-Ports | 7 × Quick-Fix |
| Betriebsmodi | Positiv / Negativ / Ausgeglichen |
| Klasse-4-Trocknung | Ja |
| Bauweise | Stapelbar, doppelwandiges Rotationsgehäuse |
...
- Holzrahmenböden im Altbau
- Fußbodenheizungssysteme mit Holzaufbau

Der Boost Bar wird in Kombination mit dem Drymatic II betrieben. Mehrere Boost Bars können an einen Drymatic II angeschlossen werden, was eine gleichmäßige Erwärmung großer Flächen ermöglicht.

---

### Trocknungsmatten – Kontrollierte Flächentrocknung

**Drymatic Trocknungsmatten** ermöglichen die direkte Wärmeübertragung auf Böden und Wände. Die strapazierfähigen, wasserabweisenden Matten werden auf die feuchte Fläche aufgelegt und verteilen die Wärme des Drymatic II gleichmäßig über die gesamte Kontaktfläche.

Vorteile gegenüber Lufttrocknung:
...
|-----|--------|------------------|
| Injektionstrocknung | 2× 7-Port-Adapter, 30 m × 38 mm Schlauch, 14 Manschetten | Wandaufbauten, Hohlraumböden via Bohrungen |
| Y-Stück | Doppeleinspeisung | Parallelbetrieb zweier Schlauchstränge |
| Abluftadapter | 150→100 mm Reduzierstück | Abluftführung nach außen |
| Küchenset | 38→25 mm, 2,5 m Schlauch | Sockelbereich, Unterbauten |
...
Zement- und Anhydritestrich muss vor dem Verlegen von Bodenbelägen eine Grenzfeuchte unterschreiten. Wärme beschleunigt diesen Prozess um Wochen und verkürzt die Bauzeit.

**Denkmalpflege und historische Gebäude**
Kontrollierte, schonende Wärme ermöglicht die Trocknung historischer Bausubstanz ohne aggressive mechanische Eingriffe.
